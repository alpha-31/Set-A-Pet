...
<form method="post" action="petsupdate.php">  
<fieldset>
...
$id = $_POST["id"];
  ...
  if($count[0]==1)
  {
    $sql = "UPDATE pets SET Pet_Type='$category', breed='$breed',weight='$weight',height='$height',age='$age',fur='$fur' ,cost='$cost' WHERE Pet_Id='$id'";
