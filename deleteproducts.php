...
$Query2="select count(*) from product where Product_Id='$pp_id'";
$Execute = mysqli_query($conn,$Query2);
$count = mysqli_fetch_row($Execute);

if($count[0]==1)
{
  $sql = "DELETE FROM product WHERE Product_Id='$pp_id'";
...
border: 3px solid #ff0000;background-color:#f44336;color:#f2f2f2;font-size:17px;" formaction="product.php">back</button>
</form>
</body>
</html>
