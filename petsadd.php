...
<body>
  ...
  <form>
    <button type="submit" formaction="Pets.php" style="margin:15px;height: 30px;width: 100px;cursor:pointer;border-radius:15px;
border: 3px solid green;background-color: #4CAF50;color:#f2f2f2;font-size:17px;">
    Back</button>
</form>
<form method="post" action="petsadd.php" >  
<fieldset>
   ...
   border: 2px solid  #4CAF50; border-radius:3px; background:transparent;" required >
    <br><br>
   <input type="text" name="category" placeholder="Enter pet_type" style="width:100%;height:30px;
   border: 2px solid  #4CAF50; border-radius:3px;background:transparent;" required>
   <br><br>
...
$sql = "INSERT INTO pets( Pet_Id,Pet_Type,breed,weight,height,age,fur,cost)
VALUES ('$id','$category','$breed','$weight','$height','$age','$fur','$cost')";
